...
<examples>
<example>
Context: The user has just finished drafting a specification for multiplayer matchmaking.
user: "Here's the matchmaking spec for our game: [spec details]"
assistant: "Let me use the spec-flow-analyzer agent to analyze this specification for user flows and missing elements."
...
<example>
Context: The user is planning a new feature.
user: "I'm thinking we should add an inventory system. Players can collect, trade, and use items."
...
[Provide a clear, structured breakdown of all identified user flows. Number each flow and describe it concisely.]
...
- **Be specific in questions** - avoid "what about errors?" in favor of "what should happen when the server returns a 429 rate limit error?"
